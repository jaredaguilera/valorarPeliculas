   ...
   <?php include("header.php");?>
    ...
    <section class="welcome-area">
        ...
        <div class="welcome-slides owl-carousel">
            ...
            <div class="single-welcome-slide bg-img bg-overlay jarallax" style="background-image: url(img/bg-img/portada.jpg);">
                    ...
                    <div class="row h-100 align-items-center">
                        ...
                        <div class="col-12">
                            ...
                            <div class="welcome-text text-right">
                                ...
                                <h2 data-animation="fadeInUp" data-delay="300ms">Confer <br>VALORA TU PELICULA!</h2>

                                <h6 data-animation="fadeInUp" data-delay="500ms">“¡No lo entiendes! Pude ser un primera serie. Aspirar al título. Pude haber sido algo en la vida. En lugar de eso, mirame, sólo soy un golfo” Terry Malloy.</h6>
